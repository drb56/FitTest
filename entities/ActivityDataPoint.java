...
/**
 * Created by David.Bickford on 6/13/2016.
 */
...
//        Date = Integer.toString(startDate.get(Calendar.MONTH+1)) + "/" +
//                Integer.toString(startDate.get(Calendar.DAY_OF_MONTH)) + "/" + Integer.toString(startDate.get(Calendar.YEAR));
    }
